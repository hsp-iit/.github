...
| [tour-guide-robot](https://github.com/hsp-iit/tour-guide-robot) | A collection of modules and classes that can be used to perform guided tours ith R1 robot or to simply interact with it. It also the repo used to perform autonomous navigation ith R1|  |  |
